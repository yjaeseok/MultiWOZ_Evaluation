...
if __name__ == '__main__':
    ...
    parser.add_argument("-d", "--dst", dest='dst', action="store_true", default=False, help="If set, dst are evaluated.")
    ...
    e = Evaluator(args.bleu, args.success, args.richness, args.dst)
